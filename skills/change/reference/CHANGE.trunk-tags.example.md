...
# 0.9.0-alpha.1): one long-lived branch, main, with higher environments named
...
#
# As of schema 0.9.0-alpha.1 the tag: rules below are declarative and
