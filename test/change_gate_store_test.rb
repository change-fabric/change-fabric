...
class ChangeGateStoreTest < Minitest::Test
  ...
  def test_two_app_runs_on_one_sha_merge_rather_than_clobber
    store = ChangeGateStore.new("abc123")
    store.record(scope: "all", status: "pass", project: "REDACTED", lanes: {}, report: "portal.md", app: "portal")
    store.record(scope: "all", status: "pass", project: "REDACTED", lanes: {}, report: "scattergram.md", app: "scattergram")
  ...
  def test_aggregate_status_fails_when_any_app_failed
    store = ChangeGateStore.new("abc123")
    store.record(scope: "all", status: "pass", project: "REDACTED", lanes: {}, report: "portal.md", app: "portal")
    store.record(scope: "all", status: "fail", project: "REDACTED", lanes: {}, report: "scattergram.md", app: "scattergram")
