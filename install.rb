...
module Install
  ...
  class Installer
    HOOKS = {
      ...
      'PreToolUse' => %w[merge_mode_guard.rb glyph_guard.rb client_name_guard.rb slop_remind.rb review_gate.rb noreply_guard.rb docker_doctrine_guard.rb change_merge_guard.rb presence_probe.rb],
